  ...
  return (
    <div style={{
      ...
      <ul style={{ paddingLeft: '1.25rem' }}>
        ...
        <li>Registrar métricas de uso (número de correos procesados, facturas detectadas) en nuestra base de datos</li>
      </ul>
      ...
      <h2 style={{ fontSize: '18px', fontWeight: 500, marginTop: '2rem' }}>6. Rights del usuario</h2>
